...
<div class="wrap">
	...
	<div class="main">
        <div>
            <label for="empId">아이디</label><input type="text" id="empId" name="empId" disabled="disabled" value="${emp.id }" >
        </div>
        <div>
          	<label for="name">이름</label><input type="text" id="name" name="name" disabled="disabled" value="${emp.name }">
        </div>
        <div>
        	<label for="rank">직책</label><input type="text" id="rank" name="rank" disabled="disabled" value="${emp.rank }">
        </div>
        <div>
